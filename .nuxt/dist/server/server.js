...
/******/ 			var chunk = require("./" + ({"1":"pages/_id","2":"pages/index"}[chunkId]||chunkId) + ".js");
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(9).default("be361e24", content, true)
...
var ___CSS_LOADER_API_IMPORT___ = __webpack_require__(8);
exports = ___CSS_LOADER_API_IMPORT___(false);
exports.push([module.i, "@import url(https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@400;500&display=swap);"]);
// Module
exports.push([module.i, "body,html{box-sizing:border-box;font-size:1rem;font-family:Roboto Mono}#__layout,#__nuxt,#geektube,body,html{height:100%}*,:after,:before{box-sizing:inherit}body,h1,h2,h3,h4,h5,h6,ol,p,ul{margin:0;padding:0;font-weight:400}ol,ul{list-style:none}.header__wrap{background:#6a5acd}input{width:100%;border:3px solid silver;padding:1rem;font-size:1.03rem;height:100%;font-family:Roboto Mono}input,input:focus{transition:all .3s}input:focus{outline:none;border:3px solid #6a5acd}.nlb{-webkit-border-top-right-radius:.5rem!important;-webkit-border-bottom-right-radius:.5rem!important;-moz-border-radius-topright:.5rem!important;-moz-border-radius-bottomright:.5rem!important;border-top-right-radius:.5rem!important;border-bottom-right-radius:.5rem!important}.nrb{-webkit-border-top-left-radius:.5rem!important;-webkit-border-bottom-left-radius:.5rem!important;-moz-border-radius-topleft:.5rem!important;-moz-border-radius-bottomleft:.5rem!important;border-top-left-radius:.5rem!important;border-bottom-left-radius:.5rem!important}img{max-width:100%;height:auto}.empty__urls{display:flex;flex-direction:column;justify-content:center;height:100%;width:100%;text-align:center}.container{max-width:100%;margin:0 auto;padding:1rem;overflow:hidden}.grid{position:relative;display:grid;grid-auto-flow:dense;grid-gap:30px;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));grid-template-rows:repeat(5,125px);top:5rem;overflow:auto}.grid__item:nth-child(3n){grid-column:span 2;grid-row:span 2}.grid__item .link__item{position:relative;display:flex;flex-direction:column;justify-content:flex-end;height:100%;flex:1 1 0;text-decoration:none;overflow:hidden;transition:all .3s}.grid__item .link__item:after{content:\"\";position:absolute;top:0;width:100%;height:100%;background:#6a5acd;background:linear-gradient(0deg,#6a5acd,transparent)}.grid__item .link__item .responsive-img{position:absolute;top:0;-o-object-position:center;object-position:center}.grid__item .link__item .title{display:flex;flex-direction:row;justify-content:space-between;padding:1rem;z-index:100;color:#fff;transition:all .3s;word-wrap:none}.grid__item .link__item .title .link__info{display:flex;flex-direction:column;justify-content:center}.grid__item .link__item .title .link__actions{display:flex;flex-direction:row}.grid__item .link__item .title .external{display:flex;flex-direction:column;justify-content:center;outline:none;padding:0 0 0 .5rem}.grid__item .link__item .title .external .external__icon{display:flex;background:transparent;border:2px solid #fff;color:#fff;padding:.45rem;border-radius:50%}.grid__item .link__item .title .external:hover{cursor:pointer}.grid__item .link__item .title .external:hover .external__icon{background:#fff;color:#6a5acd}.grid__item .link__item:before{content:\"\";position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(225,255,255,.2);z-index:0}.clip-path{-webkit-clip-path:circle(30px at center);clip-path:circle(30px at center)}.invalid:before{background:transparent!important}.invalid:after,.invalid:before{content:\"\";position:absolute;left:-3px;width:3px;height:100%}.invalid:after{background:rgba(255,0,0,.5)!important}.invalid input:focus{border:3px solid rgba(255,0,0,.5);background:rgba(255,0,0,.1)}.isloading{background:#f1f1f1;height:100%;padding:1rem;overflow:hidden}.isloading:before{content:\"\";display:block;position:absolute;left:-150px;top:0;height:100%;width:150px;-webkit-animation-duration:1.5s;animation-duration:1.5s;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards;-webkit-animation-iteration-count:infinite;animation-iteration-count:infinite;-webkit-animation-name:load;animation-name:load;-webkit-animation-timing-function:linear;animation-timing-function:linear;background:linear-gradient(90deg,transparent 0,#fff 50%,transparent)}@-webkit-keyframes load{0%{left:-150px}to{left:100%}}@keyframes load{0%{left:-150px}to{left:100%}}#shtn{position:fixed;right:0;width:100%;background:#fff;padding:1rem;z-index:200;display:flex;flex-direction:row}#shtn div{position:relative;display:flex;flex:1 1 auto;flex-direction:column}#shtn div:first-child{max-width:60px}#shtn div:nth-child(2):before{content:\"\";position:absolute;right:0;width:3px;height:100%;background:silver}#shtn div[focus-within]:before{content:\"\";position:absolute;left:-3px;width:3px;height:100%;background:#6a5acd}#shtn div:focus-within:before{content:\"\";position:absolute;left:-3px;width:3px;height:100%;background:#6a5acd}#shtn div input:last-child{border-left:0}#shtn button{background:silver;border:0;padding:0 .75rem;transition:all .3s}#shtn button:focus{outline:none}#shtn button.btnActive{background:#6a5acd}#shtn button.btnActive:hover{background:#7e6eeb}", ""]);
// Exports
module.exports = exports;
...
const state = () => ({
  ...
  urls: [],
  banned: [],
  short: ['bit.ly', 'goo.gl', 'tinyurl.com', 'ow.ly', 'su.pr', 'is.gd', 'cli.gs', 'tiny.cc', 'sn.im', 'moourl.com', 'l.gg', 'catchylink.com', 'short.nr', 'para.pt', 'twurl.nl', 'snipurl.com', 'budurl.com', 'xrl.us']
});
const mutations = {
  SET_URL(state, url) {
...
const middleware = {};
middleware['redirect'] = __webpack_require__(15);
...
const _1c4df18e = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 30)));

const _677cf83e = () => interopDefault(__webpack_require__.e(/* import() | pages/_id */ 1).then(__webpack_require__.bind(null, 29))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./layouts/error.vue?vue&type=template&id=4bc7ec42&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_vm._ssrNode(((_vm.error.statusCode === 404)?("<h1>Brew not found...</h1>"):("<h1>An error occurred</h1>"))+" "),_c('nuxt-link',{attrs:{"to":"/"}},[_vm._v("Go home")])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./layouts/error.vue?vue&type=template&id=4bc7ec42&
...
var styles_app = __webpack_require__(18);
...
external_vue_default.a.use(urls_Date);
